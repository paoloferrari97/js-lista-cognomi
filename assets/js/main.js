...
for (var i = 0; i < lista_cognomi.length; i++){
    ...
    if (lista_cognomi[i] == cognome) {
        posizione_cognome = (i + 1);  //al posto di questo (if e variabile) potevo usare lista.indexOf(nomedacercare) e mi da la sua posizione (ovviamente partono da 0 quindi farò + 1)
    }
}
